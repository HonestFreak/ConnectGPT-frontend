...
import Logo from '../images/logo/logosaas2.png';
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Profile --> */}
               ...
               <li>
                <NavLink
                  to="/giveaway"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('giveaway') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  🎁
                  Free Credits
