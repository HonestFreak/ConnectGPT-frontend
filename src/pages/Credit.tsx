...
const Credit = () => {
  ...
  const transfer = async (e) => {
    ...
    try {
        ...
        const transfer = await fetch(`api.azurewebsites.net/credit/transfer?amount=${transferamount}&bot_id=${bot_id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${accessToken}`,
  ...
  const buy = async () => {
    try {
        ...
        const createCheckoutSessionResponse = await fetch(`api.azurewebsites.net/credit/create-checkout-session?amount=${creditrange}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${accessToken}`,
